...
public class LocalVariable extends StructuralEntity implements TNamedEntity, TSourceEntity, TEntityMetaLevelDependency, TLocalVariable, TInvocationsReceiver, TStructuralEntity, TWithSourceLanguage, TTypedEntity, TAccessible, TWithComments {
    ...
    public ContainerEntity getBelongsTo() {
        return (ContainerEntity) this.getParentBehaviouralEntity();
    }

    public void setBelongsTo(ContainerEntity var1) {
        if (var1 instanceof BehaviouralEntity) {
            this.setParentBehaviouralEntity((BehaviouralEntity)var1);
        }

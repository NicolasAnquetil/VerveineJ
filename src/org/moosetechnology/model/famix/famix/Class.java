...
public class Class extends Type implements TWithExceptions, TSourceEntity, TOODependencyQueries, TReferenceable, TType, TPackageable, TNamedEntity, TWithAttributes, TWithMethods, TEntityMetaLevelDependency, TWithInheritances, TInvocationsReceiver, TWithSourceLanguage, TClass, TWithComments {
